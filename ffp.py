...
for i in range(len(p)):
    for j in range(len(firefighters)):
        for k in range(100):
            ad, t, sa = basic.stochastic_firefighting_des3(firefighters[j],n,ave_degree,graph_type,p[i])
            geo_sto_bfs[k][i][j]=[p[i],ad,t,sa/n,firefighters[j]]
            print(i,j)
np.save('geo_sto_des3',geo_sto_bfs)
print('geo done')
...
for i in range(len(p)):
    for j in range(len(firefighters)):
        for k in range(100):
            ...
            print(i,j)
np.save('erdos_sto_des3',erdos_sto_bfs)
print('erdos done')
...
for i in range(len(p)):
    for j in range(len(firefighters)):
        for k in range(100):
            ad, t, sa = basic.stochastic_firefighting_descendant4(firefighters[j],n,ave_degree,graph_type,p[i])
            geo_sto_des[k][i][j]=[p[i],ad,t,sa/n,firefighters[j]]
            print(i,j)
np.save('geo_sto_des4',geo_sto_des)
print('geo done')
graph_type='erdos'
...
for i in range(len(p)):
    for j in range(len(firefighters)):
        for k in range(100):
            ...
            print(i,j)
np.save('erdos_sto_des4',erdos_sto_des)
print('erdos done')
"""
...
for i in range(len(p)):
    for j in range(len(firefighters)):
        for k in range(100):
            ad, t, sa = basic.stochastic_firefighting_degree(firefighters[j],n,ave_degree,graph_type,p[i])
            erdos_sto_degree[i][j]=[p[i],ad,t,sa/n,firefighters[j]]
            #print(i,j)
...
for i in range(len(p)):
    for j in range(len(firefighters)):
        for k in range(100):
            ...
            geo_sto_des[i][j]=[p[i],ad,t,sa/n,firefighters[j]]
            #print(i,j)
...
for i in range(len(p)):
    for j in range(len(firefighters)):
        for k in range(100):
            ad, t, sa = basic.stochastic_firefighting_descendant(firefighters[j],n,ave_degree,graph_type,p[i])
            erdos_sto_des[i][j]=[p[i],ad,t,sa/n,firefighters[j]]
            #print(i,j)
